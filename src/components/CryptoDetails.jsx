...
function CryptoDetails() {
  ...
  console.log('coinUUID : ' , coinUUID)
  const [timePeriod, setTimePeriod] = useState('7d');
  // timeperiod for rendering the chart data 
  ...
  if(cryptoDetails.supply.total==null){
    ...
    totalSupply = cryptoDetails.supply.total;
  }

  const genericStats = [
    { title: 'Number Of Markets', value: cryptoDetails.numberOfMarkets, icon: <FundOutlined /> },
    { title: 'Number Of Exchanges', value: cryptoDetails.numberOfExchanges, icon: <MoneyCollectOutlined /> },
    { title: 'Aprroved Supply', value: millify(cryptoDetails['24hVolume']) ? <CheckOutlined /> : <StopOutlined />, icon: <ExclamationCircleOutlined /> },
